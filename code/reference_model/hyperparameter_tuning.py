...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        print("Usage: python hyperparameter_tuning.py <param_name> <value1> <value2> ...")
        print("Example: python hyperparameter_tuning.py n_filters 32 64 128")
        print("Example: python hyperparameter_tuning.py learning_rate 1e-4 1e-3 1e-2")
        sys.exit(1)

    param_name = sys.argv[1]
    param_values_str = sys.argv[2:]
